...
from loss_contrastive import ccvae_loss_supervised_paper, ccvae_loss_unsupervised_paper
...
CONTRASTIVE_WEIGHT = 50 # <--- NEW: Weight for Supervised Contrastive Loss on z_c
...
def train():
    ...
    for epoch in range(EPOCHS):
        ...
        if epoch == EPOCHS-1:
            ...
            # Save Model
            torch.save(model.state_dict(), "ccvae_haircolor_new.pth")
